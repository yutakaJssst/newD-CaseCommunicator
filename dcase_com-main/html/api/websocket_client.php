...
function websocket_write($sp,$data,$final=true,$binary=false){
...
function websocket_close($sp, $final=true,$binary=false){
  // Assemble header: FINal 0x80 | Mode (0x02 binary, 0x01 text)
  $header=chr(($final?0x80:0) | 0x08); // 0x01 text mode
