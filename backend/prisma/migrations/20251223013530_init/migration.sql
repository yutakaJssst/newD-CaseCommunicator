...
CREATE TABLE "patterns" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "patterns_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "patterns_authorId_idx" ON "patterns"("authorId");

-- CreateIndex
CREATE INDEX "patterns_isPublic_idx" ON "patterns"("isPublic");
